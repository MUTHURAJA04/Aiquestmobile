...
//   // Load user data (userId, token) from AsyncStorage on mount
//   useEffect(() => {
//     (async () => {
//       try {
...
//   // Pick Excel document (.xls or .xlsx)
...
//     if (!file) return Alert.alert('Please upload an Excel document.');
